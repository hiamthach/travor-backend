...
func (x *PaginationRes) GetPage() uint32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *PaginationRes) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_pagination_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x3d, 0x0a, 0x0a, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61,
	...
	0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x56, 0x0a, 0x0d, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x42, 0x1e, 0x5a,
...
var file_pagination_proto_goTypes = []interface{}{
	...
	(*PaginationRes)(nil), // 1: pb.PaginationRes
}
