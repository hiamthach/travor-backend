...
type DestinationServiceClient interface {
	GetDestinations(ctx context.Context, in *Pagination, opts ...grpc.CallOption) (*GetDestinationsResponse, error)
...
func (c *destinationServiceClient) GetDestinations(ctx context.Context, in *Pagination, opts ...grpc.CallOption) (*GetDestinationsResponse, error) {
...
type DestinationServiceServer interface {
	GetDestinations(context.Context, *Pagination) (*GetDestinationsResponse, error)
...
func (UnimplementedDestinationServiceServer) GetDestinations(context.Context, *Pagination) (*GetDestinationsResponse, error) {
...
func _DestinationService_GetDestinations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DestinationServiceServer).GetDestinations(ctx, req.(*Pagination))
	}
