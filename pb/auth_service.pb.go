...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x32, 0x9d, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x44, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x10, 0x2e, 0x70, 0x62,
	...
	0x74, 0x68, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x48, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61,
	...
	0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x19, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x13, 0x3a,
...
var file_auth_service_proto_depIdxs = []int32{
	...
	4, // 1: pb.User.password_changed_at:type_name -> google.protobuf.Timestamp
	0, // 2: pb.LoginResponse.user:type_name -> pb.User
	4, // 3: pb.LoginResponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
	4, // 4: pb.LoginResponse.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
	1, // 5: pb.AuthService.Login:input_type -> pb.LoginRequest
	3, // 6: pb.AuthService.CreateUser:input_type -> pb.CreateUserRequest
	2, // 7: pb.AuthService.Login:output_type -> pb.LoginResponse
	0, // 8: pb.AuthService.CreateUser:output_type -> pb.User
